...
export class ModelListFactory<T extends Model> extends RESTFactory {
    ...
    public constructToView(
        ...
        if (typeof(modelListSource) === "string") {
            ...
            rest(
                'GET',
                this.getUrlWithId(modelListSource),
                undefined,
                undefined,
                (j: object[]) => {
    ...
    /**
     * generate a URL to call for a specific id with specific query string
     * parameters
     *
     * @param qsp string containing the query string parameters as generated by
     * a Filter
     */
    protected getUrlWithId(qsp: string): string {
        return this.restHostname + this.restEndpoint + qsp;
    }
