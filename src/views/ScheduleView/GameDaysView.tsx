            ...
            <$>
                ...
                <ListView id='gameDaysList' stretchX bottom='next()' top='prev()' items={this.gameDays}>
                    <Cell highlightOnTouch onTap={
                        ...
                        <TextView stretchX top='prev()' height={this.listFont.viewHeight} font={this.listFont} alignment='centerX' textColor='#212121' bind-text='item.Identification'/>
                        ...
                        <Composite class='placeholder' stretchX top='prev()' height={0.5 * this.listFont.viewHeight}/>
                    </Cell>
                </ListView>
            </$>
        );
